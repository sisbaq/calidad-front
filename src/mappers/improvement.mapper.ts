...
export const mapApiActivityToFrontend = (
  ...
  return {
    ...
    followup1Sent: Boolean(apiActivity.actAnexoSeguimiento1),
    followup2Sent: Boolean(apiActivity.actAnexoSeguimiento2),
    followup3Sent: Boolean(apiActivity.actAnexoSeguimiento3),
    followup4Sent: Boolean(apiActivity.actAnexoSeguimiento4),
