...
export const mapApiActivityToFrontend = (
  ...
  return {
    ...
    seguimientoI: apiActivity.actSeguimiento1 || '',
    seguimientoII: apiActivity.actSeguimiento2 || '',
    seguimientoIII: apiActivity.actSeguimiento3 || '',
    seguimientoIV: apiActivity.actSeguimiento4 || '',
    seguimientoIEnviado: Boolean(apiActivity.actAnexoSeguimiento1),
    seguimientoIIEnviado: Boolean(apiActivity.actAnexoSeguimiento2),
    seguimientoIIIEnviado: Boolean(apiActivity.actAnexoSeguimiento3),
    seguimientoIVEnviado: Boolean(apiActivity.actAnexoSeguimiento4),
    seguimientoIComentario: apiActivity.actObservSeguimiento1 || undefined,
    seguimientoIIComentario: apiActivity.actObservSeguimiento2 || undefined,
    seguimientoIIIComentario: apiActivity.actObservSeguimiento3 || undefined,
    seguimientoIVComentario: apiActivity.actObservSeguimiento4 || undefined,
    planId,
    files: {
